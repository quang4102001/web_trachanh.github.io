...
function totalPrice() {
    ...
    for (let i = 0; i < document.querySelectorAll('.form__input-num').length; i++) {
        ...
        document.querySelector('.cart__total-price').innerText = +document.querySelector('.cart__total-price').innerText + +document.getElementById(totalID).innerText.split(' ')[0]
    }
    document.getElementById('input__total_cart').value = +document.querySelector('.cart__total-price').innerText
